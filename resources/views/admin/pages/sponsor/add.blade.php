                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            ...
                            <form method="POST" action="{{ route('storeSponsor') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" style="border: 1px solid #ccc; padding: 20px;">
                                                ...
                                                <img src="" id="photoPreview" alt="Sponsor Photo" style="width: 70px; height: 75px; object-fit: cover;">
                                                @error('photo')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>

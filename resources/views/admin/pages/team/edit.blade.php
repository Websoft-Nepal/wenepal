                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            ...
                            <form method="POST" action="{{ route('updateTeam',$team->slug) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="post" class="form-control" value="{{ $team->post }}">
                                                @error('post')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" style="border: 1px solid #ccc; padding: 20px;">
                                                ...
                                                <img src="{{ asset('site/Uploads/team/'.$team->photo) }}" id="photoPreview" alt="team Photo" style="width: 70px; height: 75px; object-fit: cover;">
                                                @error('photo')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
